...
// 날씨 데이터 백엔드(FastAPI) 주소.
// GitHub Pages(배포)에서 열리면 Render 백엔드로, 그 외(로컬 개발)에서는 localhost로 연결.
const RENDER_BACKEND_URL = "https://practice-weather-app-backend.onrender.com";
export const BACKEND_URL = location.hostname === "seojihun12.github.io"
  ? RENDER_BACKEND_URL
  : "http://localhost:8000";
